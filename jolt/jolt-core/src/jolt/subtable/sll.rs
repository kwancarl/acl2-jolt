...
mod test {
    ...
    // subtable_materialize_mle_parity_test!(
    //     sll_binius_materialize_mle_parity0_32,
    //     SllSubtable<BiniusField<BinaryField128b>, 0, 32>,
    //     BiniusField<BinaryField128b>,
    //     1 << 16
    // );

    // subtable_materialize_mle_parity_test!(
    //     sll_binius_materialize_mle_parity1_32,
    //     SllSubtable<BiniusField<BinaryField128b>, 1, 32>,
    //     BiniusField<BinaryField128b>,
    //     1 << 16
    // );

    // subtable_materialize_mle_parity_test!(
    //     sll_binius_materialize_mle_parity2_32,
    //     SllSubtable<BiniusField<BinaryField128b>, 2, 32>,
    //     BiniusField<BinaryField128b>,
    //     1 << 16
    // );
